...
| Phase 1 | 設計ドキュメント — DESIGN.md v4 + ROADMAP + CLAUDE.md 更新 | 🔄 進行中 |
| Phase 2 | Rust バックエンド整理 — 7コマンド体系に再編 | ⬚ 未着手 |
| Phase 3 | フロントエンド実装 — 1画面 UI 新規作成 | ⬚ 未着手 |
| Phase 4 | 統合 + リリース — E2E テスト + 品質ゲート | ⬚ 未着手 |
