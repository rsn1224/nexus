...
name: self-improve
description: >
  スキル・ルール・エージェント定義を改善するメタスキル。
  作業中に発見したパターン・バグ・ベストプラクティスをルールに昇格させる。
  Use when same mistake occurs twice, Cascade misunderstands a convention,
  or a new Tauri/React gotcha is discovered.
  Do NOT use for one-off fixes or ephemeral debugging notes.
---
...
| 内容 | 更新先 |
|------|--------|
| Tailwind クラス・デザイン規約 | `.claude/skills/nexus-design/SKILL.md` |
