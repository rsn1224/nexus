  ...
  return (
    <div className="flex gap-1 flex-wrap">
      <button
        ...
        className="text-xs px-2 py-0.5 bg-base-700 text-text-muted border-none rounded-[2px] cursor-pointer hover:text-text-primary"
      >
        全選択
      </button>
      <button
      ...
      {cpuTopology.pCores.length > 0 && cpuTopology.eCores.length > 0 && (
        <>
          <button
            ...
            className="text-xs px-2 py-0.5 bg-base-700 text-accent-500 border-none rounded-[2px] cursor-pointer"
          >
            P-Core のみ
          </button>
          <button
